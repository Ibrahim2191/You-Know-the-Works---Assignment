const element = (
        ...
        <div class="row pt-5 border-bottom border-dark">
            ...
            <div class="col-12 col-md-5 border-right">
                <div>
                    <h1 class="heading">CAROLINE <br>THOMPSON<br /> </h1>
                    <p>ART DIRECTOR</p>
                </div>
            </div>
            <div class="col-12 col-md-5">
                <div>
                    <p>Advertising campaign are my forte.</p>
                    <p>I have been in the industry for 6 years.</p>
                    <p>Address: Los Angels, California</p>
            ...
            <div class="col-12 col-md-10">
                <div class="d-flex work-exp mb-3">
                    ...
                    <div>
                        ...
                        <p>Generating and developing ideas to persent to the client</p>
                    </div>
                </div>
                <div class="d-flex work-exp mb-3">
                    <div class="me-5">
                    ...
                    <div>
                        <div>
                            <b> Mega Giants Publishing and Studio - Junior Art Director
                            </b>
                        </div>
                ...
                <div class="d-flex work-exp mb-3">
                    ...
                    <div>
                        <div>
                            <b> Big Ideas Inc - Assistant Art Director
                            </b>
                        </div>
                        <p>Commissioning specialists, such as artists, to work on project</p>
        ...
        <div class="row pt-5 border-bottom border-dark">
            ...
            <div class="col-12 col-md-10 d-flex justify-content-between">
                ...
                <div>
                    <div><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-file-music" viewBox="0 0 16 16">
        ...
        <div class="row pt-5 border-bottom border-dark">
            ...
            <div class="col-12 col-md-10">
                <div class="d-flex work-exp mb-3">
                    ...
                    <div>
                        <div>
                            <b> Alabama College of Design and Technology - Cum Laude
                            </b>
                        </div>
                ...
                <div class="d-flex work-exp mb-3">
                    ...
                    <div>
                        <div>
                            <b> Helena All Girls Senior High School - Valedictorian
                            </b>
                        </div>
